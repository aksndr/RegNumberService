 ...
 * generated in the ru.terralink.regnumservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _RegNumberKey_QNAME = new QName("http://schemas.datacontract.org/2004/07/NNxRegNumberService", "Key");
    ...
    public JAXBElement<String> createNextTemplateName(String value) {
        return new JAXBElement<String>(_NextTemplateName_QNAME, String.class, Next.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/NNxRegNumberService", name = "ID", scope = RegNumber.class)
    public JAXBElement<Integer> createRegNumberID(Integer value) {
        return new JAXBElement<Integer>(_RegNumberID_QNAME, Integer.class, RegNumber.class, value);
    }
    ...
    public JAXBElement<String> createRegNumberComment(String value) {
        return new JAXBElement<String>(_RegNumberComment_QNAME, String.class, RegNumber.class, value);
    }
    ...
    public JAXBElement<String> createRegNumberValue(String value) {
        return new JAXBElement<String>(_RegNumberValue_QNAME, String.class, RegNumber.class, value);
    }
    ...
    public JAXBElement<String> createRegNumberKey(String value) {
        return new JAXBElement<String>(_RegNumberKey_QNAME, String.class, RegNumber.class, value);
    }
